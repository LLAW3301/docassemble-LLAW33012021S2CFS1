...
setup(name='docassemble.LLAW33012021S2CFS1',
      ...
      install_requires=[],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/LLAW33012021S2CFS1/', package='docassemble.LLAW33012021S2CFS1'),
     )
